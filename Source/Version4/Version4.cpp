		...
		if (travelerList[localData->threadIndex].segmentList.size() > 0)
		{
			...
			if (!travelerList[travelerIndex].exiting)
			{
				...
				if (bestMoveVal != 99999)
				{
					...
					if (travelerList[travelerIndex].stall == false && travelerList[travelerIndex].segmentList[0].dir != bestMove)
					{
